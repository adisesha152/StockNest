...
const Login = ({ setIsLoggedIn }) => {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      setIsLoggedIn(true);
      setRedirectToDashboard(true); // Set to true to trigger redirection
        ...
        <div className='row justify-content-center'>
          <div className='col-lg-6 col-md-8 col-sm-10 center'>
            <div className='d-flex flex-column justify-content-center align-items-center text-center m-4 p-2'>
              ...
              <p className='text-secondary mt-2'><Link to='/signinphone' className='text-decoration-none text-secondary'>Sign in using Phone Number</Link></p>
